...
const STORAGE_KEY = 'wyze-bundle-builder-v4';
    ...
    <div className="min-h-screen bg-[#f3f3f3] py-5 sm:py-8 px-3 sm:px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-6 xl:hidden">
          <h1 className="text-3xl sm:text-5xl leading-none font-semibold text-[#1f1f1f]">Let's get started!</h1>
        </div>
        <div className="builder-shell">
          <div className="flex-1 min-w-0">
            {/* Step 1 */}
            <div className={`${expandedStepId === 1 ? 'bg-[#EDF4FF]' : 'bg-white'} rounded-t-xl p-4 sm:p-6`}>
              <div
              ...
              <div className="step-header-row" onClick={() => toggleStep(1)}>
                ...
                <div className="step-header-right">
                  {getSelectedCount(1) > 0 && <span className="whitespace-nowrap">{getSelectedCount(1)} selected</span>}
                  <svg className={`w-5 h-5 transition-transform shrink-0 ${expandedStepId === 1 ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {expandedStepId === 1 && (
                <>
                  <div className="product-grid-step1">
                  ...
                  <div className="flex justify-center mt-4 w-full">
                    <div className="w-full sm:w-full md:w-1/2 xl:w-1/4">
                      <ProductCard
            ...
            <div className={expandedStepId === 2 ? 'bg-[#EDF4FF]' : 'bg-white'}>
              <div className="px-4 sm:px-6 py-4 sm:py-5">
                ...
                <div className="step-header-row" onClick={() => toggleStep(2)}>
                  <div className="step-header-left">
                  ...
                  <div className="step-header-right">
                    {getSelectedCount(2) > 0 && <span className="whitespace-nowrap">{getSelectedCount(2)} selected</span>}
                    <svg className={`w-5 h-5 text-indigo-600 transition-transform shrink-0 ${expandedStepId === 2 ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={expandedStepId === 3 ? 'bg-[#EDF4FF]' : 'bg-white'}>
              <div className="px-4 sm:px-6 py-4 sm:py-5">
                ...
                <div className="step-header-row" onClick={() => toggleStep(3)}>
                  <div className="step-header-left">
                  ...
                  <div className="step-header-right">
                    {getSelectedCount(3) > 0 && <span className="whitespace-nowrap">{getSelectedCount(3)} selected</span>}
                    <svg className={`w-5 h-5 transition-transform shrink-0 ${expandedStepId === 3 ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M19 9l-7 7-7-7" />
                    </svg>
                  </div>
                </div>
            ...
            <div className={expandedStepId === 4 ? 'bg-[#EDF4FF]' : 'bg-white'}>
              <div className="px-4 sm:px-6 py-4 sm:py-5">
                ...
                <div className="step-header-row" onClick={() => toggleStep(4)}>
                  <div className="step-header-left">
                  ...
                  <div className="step-header-right">
                    {getSelectedCount(4) > 0 && <span className="whitespace-nowrap">{getSelectedCount(4)} selected</span>}
                    <svg className={`w-5 h-5 transition-transform shrink-0 ${expandedStepId === 4 ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M19 9l-7 7-7-7" />
                    </svg>
                  </div>
                </div>
                    ...
                    {planItems.map(item => (
                      <div key={item.id} className="flex items-center justify-between py-1.5">
                        ...
                        <div className="text-right">
                          ...
                          <div className="price-main" style={{ color: '#4E2FD2' }}>${item.product.price.toFixed(2)}/mo</div>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <>
                    <div className="review-block">
                      <div className="flex items-center justify-between py-1.5">
                        <div className="flex items-center gap-3">
                          <img
                            src={staticItems.shipping.thumbnail}
                            alt=""
                            className="w-9 h-9"
                            onError={(e) => {
                              e.currentTarget.onerror = null;
                    ...
                    <div className="review-footer">
                      <div className="review-footer-badge">
                        100%
                        <br />
                      ...
                      <div className="review-footer-content">
                        ...
                        <div
                          ...
                          onKeyDown={(e) => e.key === 'Enter' && alert('System saved to localStorage!')}
                          role="button"
                          tabIndex={0}
                        >
